    ...
    (function () {
        ...
        window.resetTimeout = function () {
            ...
            if (!u) {
                t = window.setTimeout(function () {
                    var a = "network_failure.html";
                    if (n) {
                        a = "https://julian20yt.github.io/youtube/network-failure?retry-url=" + encodeURIComponent(window.location.href.split("#")[0]);
                    }
        ...
        if (c || e) {
            ...
            if (c) {
                ...
                var cssPath = window.environment.tv_css || "https://web.archive.org/web/20160513131835/http://www.youtube.com/s/tv/html5/2b66a9e6/app-prod.css";
        ...
        if (g) {
            loadScript(e || c ? r + "../media-diagnostics-debug.js" : r + "../media-diagnostics.js");
        }
